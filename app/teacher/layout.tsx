...
const navItems = [
    { name: 'Inicio (Resumen)', href: '/teacher', icon: LayoutDashboard },
    { name: 'Mis Cursos', href: '/teacher/courses', icon: BookOpen },
    { name: 'Asistencias', href: '/teacher/asistencias', icon: ClipboardCheck },
    { name: 'Horario', href: '/teacher/horario', icon: CalendarDays },
    { name: 'Perfil', href: '/teacher/profile', icon: User },
];
                    ...
                    <div className="px-6 py-6 border-b border-gray-50 bg-gray-50/30">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-xs text-gray-500 truncate capitalize">{user?.rol || 'Profesor'}</p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="flex-1 flex flex-col min-h-screen overflow-hidden">
                    ...
                    <header className="lg:hidden bg-white border-b border-gray-200 h-16 flex items-center justify-between px-4 shadow-sm z-30 sticky top-0">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-bold text-[#1e3a8a]">EPE Profesor</span>
                        </div>
                        <button
