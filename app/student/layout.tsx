...
const navItems = [
    { name: 'Inicio (Resumen)', href: '/student', icon: LayoutDashboard },
    { name: 'Explorar Cursos', href: '/student/explore', icon: Compass },
    { name: 'Mis Cursos Inscritos', href: '/student/courses', icon: BookOpen },
    { name: 'Solicitar Certificado', href: '/student/certificate', icon: Award },
    { name: 'Votar Cursos', href: '/student/votar', icon: ThumbsUp },
                ...
                >
                    ...
                    <div className="p-6 flex items-center justify-between border-b border-gray-100">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-xl font-bold text-[#1e3a8a] leading-tight">EPE<br /><span className="text-sm font-semibold text-gray-500">Alcalá</span></h2>
                            </div>
                        </div>
                    ...
                    <div className="px-6 py-6 border-b border-gray-50 bg-gray-50/30">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-xs text-gray-500 truncate capitalize">{user?.rol === 'student' ? 'Estudiante' : user?.rol}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <nav className="flex-1 overflow-y-auto py-6 px-4 space-y-1.5">
                        {navItems.map((item) => {
                            ...
                            return (
                                ...
                                >
                                    <Icon size={20} className={isActive ? 'text-[#1e3a8a]' : 'text-gray-500'} />
                                    {item.name}
                                </Link>
                            );
                        })}
                ...
                <div className="flex-1 flex flex-col min-h-screen overflow-hidden">
                    ...
                    <header className="lg:hidden bg-white border-b border-gray-200 h-16 flex items-center justify-between px-4 shadow-sm z-30 sticky top-0">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="font-bold text-[#1e3a8a]">EPE Estudiante</span>
                        </div>
                        <button
