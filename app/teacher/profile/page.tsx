        ...
        <main className="max-w-7xl mx-auto px-6 py-8">
            ...
            <div className="max-w-2xl space-y-6">
                ...
                <Card className="bg-white shadow-sm border border-gray-100 rounded-2xl overflow-hidden">
                    <CardHeader className="p-8 border-b border-gray-50 bg-gradient-to-br from-blue-50 to-indigo-50">
                    ...
                    <CardContent className="p-8 space-y-6">
                        <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <div className="space-y-2">
                                ...
                                />
                                <p className="text-xs text-gray-400">El correo electrónico no puede ser modificado por el usuario.</p>
                            </div>
                ...
                {/* Info card */}
                <Card className="bg-blue-50/50 border border-blue-100 rounded-2xl p-6">
                    <p className="text-sm text-blue-800 font-semibold mb-1">Rol de tu cuenta</p>
                    <p className="text-sm text-blue-700">
                        Como <strong>Profesor</strong>, tienes acceso a la gestión de cursos asignados, registro de asistencias, publicación de horarios y visualización de estudiantes inscritos.
                    </p>
                </Card>
            </div>
        </main>
